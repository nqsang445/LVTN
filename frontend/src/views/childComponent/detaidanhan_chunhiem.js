...
function DeTaiDaNhan() {
    ...
    let getListDeTai = async () => {
        try {
            const listDeTai = await axios.post(`http://localhost:8080/api/get-all-list-detai-danhan-chunhiem`, paramUserId)
    ...
    return (
        <>
            ...
            <div>
                ...
                <h1>Đề tài Đang thực hiện: </h1>
                                            ...
                                            <>
                                                ...
                                                <td>
                                                    <button className="btn btn-success"
                                                        onClick={() => handleModalDangKyNghiemThuDeTai(item)}
