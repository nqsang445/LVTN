...
function DanhSachSVCLCCopy() {
    ...
    return (<>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <label className="my-1 mr-2" htmlFor="gender">Trạng thái:</label>&nbsp;
            <select
            ...
            &nbsp;
            <label className="my-1 mr-2" htmlFor="gender" hidden> Khối: </label>&nbsp;
            <input
                type='text'
                name="khoi"
                id="khoi"
...
export default DanhSachSVCLCCopy;