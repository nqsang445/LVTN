...
function DeTaiDangThucHienSinhVien() {
    let paramDeTaiId = useParams();
    // console.log(paramDeTaiId);
    ...
    let getDetai = async () => {
        try {
            let infoDeTai = await axios.post(`http://localhost:8080/api/get-info-detai-user-sinhvien`, { id: paramDeTaiId })
            if (infoDeTai) {
    ...
    return (<>
        ...
        <div>
            <h1>Đề tài đang hướng đẫn</h1>
...
export default DeTaiDangThucHienSinhVien;
