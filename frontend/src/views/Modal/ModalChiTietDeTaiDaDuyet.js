...
function ModalChiTietDeTaiDaDuyet({ setOpenModalChiTietDeTaiDaDuyet, openModalChiTietDeTaiDaDuyet, thongtindetai, goilai }) {
    //toggle chi danh cho toggle modal
    const toggle = () => setOpenModalChiTietDeTaiDaDuyet(!openModalChiTietDeTaiDaDuyet);
    ...
    // handleDownLoadThoiGianVaDiaDiemBaoVeDeCuong
    return (
        <Modal isOpen={openModalChiTietDeTaiDaDuyet} toggle={toggle} className='modalchitiet'>
            <ModalHeader
            ...
            <ModalBody >
                <table className="table-bordered table">
                    <thead key={thongtindetai.id}>
                        ...
                        {/* {thongtindetai.kinhphidetai.replace(/\B(?=(\d{3})+(?!\d))/g, ',')} (VNĐ) */}
                        <tr >
                        ...
                        <tr >
                            ...
                            {thongtindetai.thoigianvadiadiembaovedecuong ?
                                <td>
                                    ...
                                    {/* <button className="btn btn-success"
                                        onClick={() => handleDownLoadThoiGianVaDiaDiemBaoVeDeCuong(thongtindetai.id)}
                                    > {thongtindetai.thoigianvadiadiembaovedecuong}</button> */}
                                </td>
                                :
                                <td>Đang cập nhật....</td>
                            }
...
export default ModalChiTietDeTaiDaDuyet;