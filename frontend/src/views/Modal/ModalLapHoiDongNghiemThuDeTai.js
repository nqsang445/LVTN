...
function ModalLapHoiDongNghiemThuDeTai({ setOpenModalLapHoiDongNghiemThuDeTai, openModalLapHoiDongNghiemThuDeTai, infoDetai, goilai }) {
    //toggle chi danh cho toggle modal
    const toggle = () => setOpenModalLapHoiDongNghiemThuDeTai(!openModalLapHoiDongNghiemThuDeTai);
    ...
    const onSubmit = async (data) => {
        try {
            const res = await axios.post(`http://localhost:8080/api/post-them-hoidong-detai-nghiemthu`, { data, infoDetai })
            goilai();
            setOpenModalLapHoiDongNghiemThuDeTai(!openModalLapHoiDongNghiemThuDeTai);
            toast.success('Thêm hội đồng nghiệm thu thành công');
    ...
    return (
        <Modal isOpen={openModalLapHoiDongNghiemThuDeTai} toggle={toggle}>
            <ModalHeader
                onClick={toggle} >Lập hội đồng nghiệm thu đề tài: </ModalHeader>
            <ModalBody>
                <div className="row">
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-6">
                                ...
                                <input
                                    ...
                                    id="hvtthanhvien1"
                                    placeholder="Họ và tên"
                                    {...register("hvtthanhvien1", { required: true })}
                                    onChange={(e) => handleFilterThanhVien1(e)}
                                    value={hvt3}
                                />
                            </div>
...
export default ModalLapHoiDongNghiemThuDeTai;