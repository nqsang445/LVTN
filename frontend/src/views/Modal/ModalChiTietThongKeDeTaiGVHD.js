...
function ModalChiTietThongKeDeTaiGVHD({ setOpenModalChiTietThongKeDeTaiGVHD, openModalChiTietThongKeDeTaiGVHD, thongtindetai }) {
    //toggle chi danh cho toggle modal
    const toggle = () => setOpenModalChiTietThongKeDeTaiGVHD(!openModalChiTietThongKeDeTaiGVHD);
    ...
    return (
        <Modal isOpen={openModalChiTietThongKeDeTaiGVHD} toggle={toggle} className='modalchitiet'>
            <ModalHeader
...
export default ModalChiTietThongKeDeTaiGVHD;