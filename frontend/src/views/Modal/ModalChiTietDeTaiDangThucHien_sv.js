...
function ModalChiTietDeTaiDangThucHienSV({ setOpenModalChiTietDeTaiDangThucHienSV, openModalChiTietDeTaiDangThucHienSV, infoDetai }) {
    //toggle chi danh cho toggle modal
    const toggle = () => setOpenModalChiTietDeTaiDangThucHienSV(!openModalChiTietDeTaiDangThucHienSV);
    ...
    return (
        <Modal isOpen={openModalChiTietDeTaiDangThucHienSV} toggle={toggle} className='modalchitiet'>
            <ModalHeader
...
export default ModalChiTietDeTaiDangThucHienSV;